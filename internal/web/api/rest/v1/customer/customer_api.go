...
import (
	...
	"hamburgueria/internal/web/api/rest/v1/customer/presenter"
	"hamburgueria/internal/web/api/rest/v1/customer/request"
...
func (c *Api) GetCustomer(ctx echo.Context) error {
...
func (c *Api) AddCustomer(ctx echo.Context) error {
